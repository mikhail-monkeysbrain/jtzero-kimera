...
echo "======================================================================"
echo "JT-ZERO — REPEATABILITY 175 мм"
echo "======================================================================"
...
echo "  - DISARM_DELAY=0;"
echo "  - FC ARMED;"
echo "  - аппарат всё время перемещается строго на 175 мм без подъёма/наклона."
echo
...
for ((i=1;i<=COUNT;i++)); do
  ...
  JTZERO_FLOW_GUIDED_MODE=armed-gate-open bash tools/run_optical_flow_mavlink_bench.sh
...
echo "======================================================================"
python3 tools/analyze_optical_flow_repeatability_175.py "${CSV[@]}"
