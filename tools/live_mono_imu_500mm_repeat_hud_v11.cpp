// JT-ZERO 500 mm x6 v11 — raw-recording diagnostic.
...
constexpr const char* kV8CsvPath = "/home/vio/jtzero_500mm_v11_legs.csv";
constexpr const char* kV11CombinedPath = "/home/vio/jtzero_500mm_v11.csv";
constexpr const char* kV11CameraPath = "/home/vio/jtzero_500mm_v11_camera.csv";
constexpr const char* kV11MjpegPath = "/home/vio/jtzero_500mm_v11.mjpg";
constexpr const char* kV11AttitudePath = "/home/vio/jtzero_500mm_v11_attitude.csv";
constexpr const char* kV8WindowName = "JT-ZERO 500 мм x6 v11 — startup-gated";
...
void saveBackendTraceV8(const std::vector<VioState>& states,
  ...
  const char* path = "/home/vio/jtzero_500mm_v11_backend.csv";
...
int main(int argc,char**argv){
  ...
  try{
    ...
    if(!raw_combined||!raw_camera||!raw_mjpg||!raw_attitude)
    ...
    size_t raw_imu_rows=0,raw_camera_rows=0,raw_attitude_rows=0;
    ...
    raw_combined.flush();raw_camera.flush();raw_mjpg.flush();raw_attitude.flush();
    std::cout<<"RAW IMU CSV: "<<kV11CombinedPath<<" rows="<<raw_imu_rows<<"\n"
             ...
             <<"LEGS CSV: "<<kV8CsvPath<<"\n"
             <<"BACKEND CSV: /home/vio/jtzero_500mm_v11_backend.csv\n";
