...
#define JTZERO_SUMMARY_TITLE "500 MM SINGLE-LEG V25 ISOLATED TEST"
#define JTZERO_SUMMARY_FUSION "fresh VIO process per leg; pure FRD->FLU, ZXY OFF, gravity feedback OFF"
