...
- [ ] Проверить охлаждение и температуру CPU — температура 52.1°C, throttling=0x0; тип охлаждения ещё не подтверждён
- [x] Зафиксировать версии GCC, CMake и Git — GCC/G++ 14.2.0, Git 2.47.3, CMake пока не установлен
- [ ] **Этап 1 завершён**
