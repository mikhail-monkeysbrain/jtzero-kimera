...
- [ ] Подтвердить модель Raspberry Pi 5
- [ ] Подтвердить 64-bit ARM64 архитектуру
- [ ] Зафиксировать версию Debian / Raspberry Pi OS
- [ ] Зафиксировать версию ядра
- [ ] Зафиксировать объём RAM и swap
- [ ] Проверить свободное место
- [ ] Проверить охлаждение и температуру CPU
- [ ] Зафиксировать версии GCC, CMake и Git
- [ ] **Этап 1 завершён**

## Этап 2. Подготовить системные зависимости

- [ ] Обновить список пакетов
- [ ] Установить базовые build-инструменты
- [ ] Установить Eigen
- [ ] Установить OpenCV development packages
- [ ] Установить glog и gflags
- [ ] Установить Boost
- [ ] Установить SuiteSparse
- [ ] Установить TBB
- [ ] Зафиксировать фактически необходимые пакеты для текущей ОС
- [ ] **Этап 2 завершён**
