// JT-ZERO live Mono+IMU yaw-only HUD v2.
// Protocol: 10 s INIT -> rotate yaw to ~90 deg -> automatic 10 s HOLD.
// Validity: FC yaw 85..95 deg, max |dRoll| <=2 deg, max |dPitch| <=2 deg.
...
constexpr const char* kYawV2VioCsv = "/home/vio/jtzero_live_yaw_only_v2_vio.csv";
constexpr const char* kYawV2FcCsv  = "/home/vio/jtzero_live_yaw_only_v2_fc.csv";
constexpr const char* kYawV2Window = "JT-ZERO YAW-ONLY HUD v2";
...
static void renderHud(const cv::Mat& gray,
  ...
  txt(canvas,"JT-ZERO YAW-ONLY VALIDATION v2",{24,48},1.0,{245,245,245},3);
...
int main(int argc,char**argv){
  ...
  try{
    ...
    std::cout<<"\nYAW-ONLY HUD v2: 10s INIT -> rotate to 90deg -> auto 10s HOLD\n";
    ...
    std::cout<<"\n============================================================\nJT-ZERO YAW-ONLY HUD v2 RESULT\n============================================================\n"
